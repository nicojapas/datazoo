...
# -*- coding: utf-8 -*-
#
# visualization documentation build configuration file
#
...
_version_py = os.path.join(repo, 'visualization', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'visualization.tex', 'visualization Documentation',
     'Nicolás Japas', 'manual'),
]
